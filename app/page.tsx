      ...
      <div>
        ...
        <div className="mb-3 mt-16 sm:mt-32">
          ...
          <div className="flex flex-col gap-7 sm:gap-4">
            ...
            <a href="https://github.com/ruzzelwidjaja/DublinBusPredict" target="_blank" className="-mx-3 flex flex-col rounded-md px-3 no-underline hover:bg-zinc-800 sm:py-3">
